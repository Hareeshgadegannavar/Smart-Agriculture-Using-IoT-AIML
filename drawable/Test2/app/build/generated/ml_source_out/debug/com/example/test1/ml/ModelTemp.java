...
public final class ModelTemp {
  @NonNull
  private final Model model;

  private ModelTemp(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "model_temp.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static ModelTemp newInstance(@NonNull Context context) throws IOException {
    return new ModelTemp(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static ModelTemp newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new ModelTemp(context, options);
  }

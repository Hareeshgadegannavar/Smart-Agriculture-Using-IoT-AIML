...
public final class DataModel {
  ...
  private DataModel(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "data_model.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static DataModel newInstance(@NonNull Context context) throws IOException {
    return new DataModel(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static DataModel newInstance(@NonNull Context context, @NonNull Model.Options options)
      throws IOException {
    return new DataModel(context, options);
  }

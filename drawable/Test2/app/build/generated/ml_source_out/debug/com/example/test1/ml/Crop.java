...
public final class Crop {
  ...
  private Crop(@NonNull Context context, @NonNull Model.Options options) throws IOException {
    model = Model.createModel(context, "crop.tflite", options);
    MetadataExtractor extractor = new MetadataExtractor(model.getData());
  }

  @NonNull
  public static Crop newInstance(@NonNull Context context) throws IOException {
    return new Crop(context, (new Model.Options.Builder()).build());
  }

  @NonNull
  public static Crop newInstance(@NonNull Context context, @NonNull Model.Options options) throws
      IOException {
    return new Crop(context, options);
  }
